...
def get_argparser():
    ...
    parser.add_argument("--ptrr", type=str, default = 'falsee')
    parser.add_argument("--viz", action = "store_true")
    #want to use pretrained or scratch model for iterpretability
    parser.add_argument("--ptr", action = "store_true")
    parser.add_argument("--jobid", type=int, default = 55555555)
